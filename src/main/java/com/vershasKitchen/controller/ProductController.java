...
public class ProductController {
	...
	public ProductUploadResponse uploadProduct(@RequestBody ProductEntity product) {
		ProductEntity storedImage = productService.storeProduct(product.getName(), product.getPrice(),
				product.getImagePath(), product.getIsPopular(), product.getCategory(), product.getSubcategory());
